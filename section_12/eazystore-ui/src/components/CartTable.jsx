    ...
    <div className="min-h-80 mx-auto my-8 w-full font-primary flex flex-col sm:flex-row">
      ...
      <table className="w-full mt-2 sm:w-1/3 sm:ml-2 sm:mt-0 border border-gray-400 dark:border-gray-600 h-fit">
          ...
          <tbody>
            ...
            <tr>
                <td>
                    <button className="mx-auto my-2 py-2 px-4 text-dark bg-light dark:bg-dark hover:bg-gray-700 dark:text-light hover:dark:bg-gray-400 text-sm font-semibold rounded-sm flex justify-center items-center transition">
                        Proceed to Checkout
