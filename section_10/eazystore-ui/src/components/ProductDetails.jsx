      ...
      <div className="max-w-5xl w-full mx-auto flex flex-col md:flex-row md:space-x-8 px-6 p-8">
        ...
        <div className="w-full md:w-1/2 flex flex-col space-y-6 mt-8 md:mt-0">
          ...
          <div className="flex flex-col space-y-4">
            ...
            {/* Add to Cart Button */}
            <button className="w-full px-4 py-2 text-dark bg-light dark:bg-dark hover:bg-gray-700 dark:text-light hover:dark:bg-gray-400 rounded-md text-lg font-semibold transition">
              Add to Cart
