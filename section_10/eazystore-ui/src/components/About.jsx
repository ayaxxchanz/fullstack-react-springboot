...
export default function About() {
  const h3Style = "text-lg font-bold text-light dark:text-lighter mb-2";
  const pStyle = "text-gray-600 dark:text-dark";

  return (
    <div className="max-w-[1152px] min-h-[852px] mx-auto px-6 py-8">
      <PageTitle title="About Us" />
      {/* About Us Content */}
      <p className="leading-6 mb-8 text-light dark:text-dark">
      ...
      <h2 className="text-2xl leading-[32px] font-bold mb-6 text-light dark:text-dark">
        Why Choose Us?
      </h2>
