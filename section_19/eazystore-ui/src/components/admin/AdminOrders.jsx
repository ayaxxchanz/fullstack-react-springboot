      ...
      {orders.length === 0 ? (
        ...
        <div className="space-y-6 mt-4">
          ...
          {orders.map((order) => (
            <div
              key={order.orderId}
              className="bg-white dark:bg-light-2 shadow-md rounded-md p-6 border border-gray-300 dark:border-gray-700 hover:shadow-lg hover:border-black dark:hover:border-gray-300 transition"
            >
              ...
              <div className="flex flex-wrap items-center justify-between mb-4">
                ...
                <div className="flex space-x-4 mt-4 lg:mt-0">
                  <button
                    ...
                    className="px-6 py-2 text-dark bg-light dark:bg-dark hover:bg-gray-700 dark:text-light hover:dark:bg-gray-400 text-md rounded-md transition duration-200"
                  >
                    Confirm
                  </button>
                  <button
