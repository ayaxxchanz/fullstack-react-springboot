...
function App() {
  return (
    <>
      <h1 className="text-3xl font-bold underline font-mysite">
        Hello world!
      </h1>
      ...
      <div className="bg-green-200 border border-amber-600 p-4 m-4 rounded-lg">Border demo</div>
      <div className="grid grid-cols-3 gap-4 mt-4">
        <div className="bg-blue-200 p-4 text-red-700">1</div>
        <div className="bg-blue-400 p-4">2</div>
        <div className="bg-blue-400 p-4 text-white">3</div>
      </div>
      ...
      <button className="px-6 py-2 m-4 bg-red-500 text-white rounded-lg hover:bg-red-700 transition duration-500 ease-in-out transform hover:scale-110">Click Me</button>
      <div className="max-w-sm rounded-lg shadow-lg bg-indigo-100 p-6">
        <h2 className="text-2xl font-bold mb-4">Tailwind Card</h2>
        <p classname="text-gray-700">This is a simple card build with Tailwind CSS.</p>
      ...
      <div className="bg-mysite-500 h-[165px] w-[300px] border-green-600 p-4 rounded-lg m-4 flex items-center justify-center">
        Theme variables
      </div>
      <div className="bg-primary font-mysite h-[165px] w-[300px] border-green-600 p-4 rounded-lg m-4 flex items-center justify-center">
