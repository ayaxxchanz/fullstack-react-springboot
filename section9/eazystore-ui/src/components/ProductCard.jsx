...
export default function ProductCard({ product }) {
  return (
    <div className="w-72 rounded-md mx-auto border border-gray-300 dark:border-gray-700 shadow-md overflow-hidden flex flex-col bg-white hover:shadow-lg transition">
