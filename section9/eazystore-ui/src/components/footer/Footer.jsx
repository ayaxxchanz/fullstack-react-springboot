...
export default function Footer(){
    return (
        <footer className="flex justify-center items-center py-4 text-light dark:text-dark">
            ...
            by <a href="https://www.aliya-h.com/" target="_blank" rel="noreferrer" className="font-semibold px-1 transition-colors duration-300 hover:text-secondary">Aliya H.</a>
        </footer>
    )
}