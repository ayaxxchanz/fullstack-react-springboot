        ...
        return (
            <header className="border-b border-gray-300 sticky top-0 z-20 bg-secondary">
                <div className="flex items-center justify-between mx-auto max-w-[1152px] px-6 py-4">
                    <a href="/" className="text-center text-lg font-semibold py-2">
                    ...
                    <nav className="flex items-center z-10">
                        ...
                        <button onClick={toggleTheme}
                            className="cursor-pointer flex items-center justify-center mx-3 w-8 h-8 rounded-full border bg-dark dark:bg-light dark:text-dark border-primary transition duration-300 hover:bg-amber-200 dark:hover:text-light"
