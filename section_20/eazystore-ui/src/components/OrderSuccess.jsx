...
export default function OrderSuccess() {
  return (
    <div className="min-h-[852px]  py-12 sm:pt-20 font-primary bg-normalbg dark:bg-darkbg">
      ...
      <div className="text-center text-lg text-gray-600 dark:text-dark flex flex-col items-center">
        ...
        <Link
          to="/home"
          className="px-6 py-3 text-dark bg-light dark:bg-dark hover:bg-gray-700 dark:text-light hover:dark:bg-gray-400 text-xl rounded-md transition duration-200"
        >
          Keep Shopping
        </Link>
      </div>
