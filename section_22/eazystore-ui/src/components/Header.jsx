...
import { selectTotalQuantity } from "../store/cart-slice"; // replace context with redux
import { selectIsAuthenticated, selectUser, logout } from "../store/auth-slice"; // replace context with redux
...
const Header = () => {
    ...
    const totalQuantity = useSelector(selectTotalQuantity); // replacing context with redux
    // const {isAuthenticated, user, logout} = useAuth();
    const dispatch = useDispatch(); // replacing context with redux
    const isAuthenticated = useSelector(selectIsAuthenticated); // replacing context with redux
    const user = useSelector(selectUser); // replacing context with redux
    ...
    const dropdownLinkClass =
        "block w-full text-left px-4 py-2 text-lg font-primary font-semibold text-primary dark:text-dark hover:bg-gray-200 dark:hover:bg-gray-600";
