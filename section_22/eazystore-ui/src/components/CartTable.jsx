...
import { selectCartItems, addToCart, removeFromCart } from "../store/cart-slice"; // replace context with redux
            ...
            >
              ...
              <td className="px-4 sm:px-6 py-4">
                <button
                  ...
                  onClick={() => dispatch(removeFromCart({productId: item.productId}))} // replace context with redux
