...
import com.eazybytes.eazystore.dto.request.LoginRequestDto;
import com.eazybytes.eazystore.dto.request.RegisterRequestDto;
import com.eazybytes.eazystore.dto.response.LoginResponseDto;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody RegisterRequestDto registerRequestDto) {
        ...
        roleRepository.findByName("ROLE_USER").ifPresent(role -> customer.setRoles(Set.of(role))); // because findByName returns an Optional of Role. So if that Role is present in db, then assign that role to the customer
        // no longer need to create role manually
//        Role role = new Role();
