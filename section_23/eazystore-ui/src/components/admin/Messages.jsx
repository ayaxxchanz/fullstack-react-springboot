      ...
      {messages.length === 0 ? (
        ...
        <div className="overflow-x-auto">
          ...
          <table className="w-full mt-4 table-fixed border-collapse border border-gray-200 dark:border-gray-700">
            <thead>
              <tr className="bg-primary dark:bg-light text-lighter">
            ...
            <tbody>
              {messages.map((message) => (
                <tr
                  ...
                  className=" bg-white dark:bg-light-2 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200"
                >
                  <td className="border px-4 py-2 break-words border-gray-300 dark:border-gray-700">
                    {message.name}
                  </td>
                  <td className="border px-4 py-2 break-words border-gray-300 dark:border-gray-700">
                    {message.email}
                  ...
                  <td className="border px-4 py-2 break-words max-w-[300px] overflow-auto border-gray-300 dark:border-gray-700">
                    {message.message}
                  </td>
                  <td className="border px-4 py-2 text-center border-gray-300 dark:border-gray-700">
                    <button
